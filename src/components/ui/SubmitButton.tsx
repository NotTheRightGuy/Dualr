...
const SubmitButton = () => {
  ...
  return (
    <motion.button
      ...
      className="group relative overflow-hidden rounded-r-lg border-l-[1px] border-light-4 bg-dark-2 px-4 py-2 font-mono font-medium uppercase text-neutral-300 transition-colors hover:text-indigo-300"
    >
